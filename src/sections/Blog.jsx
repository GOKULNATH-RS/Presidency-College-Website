    ...
    <div className="mx-4 sm:mx-8 md:mx-16 px-4 sm:px-8 md:px-14">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 sm:mb-0">
        ...
        <div className="mb-4 sm:mb-0">
          <p className="text-[24px] sm:text-[32px] md:text-[40px] font-medium">Read Our Blog </p>
        ...
        <div className="flex flex-nowrap gap-4 sm:gap-6">
          {blog.map((item) => (
            ...
            >
              ...
              <div>
                <p className="text-[18px] sm:text-[20px] md:text-[24px] font-medium">{item.heading}</p>
                <div className="flex justify-between items-center">
                  <p className="w-[220px] sm:w-[280px] md:w-[320px] text-[14px] sm:text-[16px] md:text-[18px]">{item.desc}</p>
                  <button className="h-[40px] w-[40px] sm:h-[50px] sm:w-[50px] md:h-[60px] md:w-[60px] flex-center rounded-full bg-blue flex items-center justify-center">
                    <img src={rightArrow} alt="Right Arrow" />
                  </button>
                </div>
